...
# Load the data
df_avg = pd.read_csv('times_WS.csv')
df_best = pd.read_csv('best_time_WS.csv')
...
ax1.bar3d(x, y, z, dx, dy, dz, color=(0.5, 1.0, 0.5), shade=True)
...
ax2.bar3d(x, y, z, dx, dy, dz, color=(0.5, 1.0, 0.5), shade=True)
