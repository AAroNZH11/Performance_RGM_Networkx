...
# Load the data
df_avg = pd.read_csv('times_ER.csv')
df_best = pd.read_csv('best_time_ER.csv')
...
specific_ticks = np.arange(0, 23, 1)
ax1.set_zticks(specific_ticks)
ax2.set_zticks(specific_ticks)
